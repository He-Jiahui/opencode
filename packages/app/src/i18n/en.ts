export const dict = {
  ...
  "session.plan.choose": "Plan file",
  "session.plan.change": "Change plan file",
  "session.plan.enable": "Continue plan",
  "session.plan.disable": "Pause plan mode",
  "session.plan.clear": "Clear plan file",
  "session.plan.openFromFile": "From file",
  "session.plan.marker": "Completion marker: {{marker}}",
  "session.plan.milestoneTag": "Milestone tag: {{open}}...{{close}}",
  "session.plan.milestones": "Milestones",
  "session.plan.milestone": "Milestone {{count}}",
  "session.plan.complete.title": "Plan complete",
  "session.plan.complete.description": "The agent returned the completion marker.",
  "session.plan.block.label": "Plan",
  "session.plan.block.save": "Save plan to workspace",
  "session.plan.block.copy": "Copy plan",
  "session.plan.block.continue": "Use and continue",
  "session.plan.block.saved.title": "Plan saved",
  "session.plan.block.ready.title": "Plan ready",
  "session.plan.block.ready.description": "Use the plan continue button in the plan slot when the session is idle.",
  "session.workflow.start": "Start workflow",
  "session.workflow.startAnother": "New workflow",
  "session.workflow.belongsTo": "Workflow",
  "session.workflow.started.title": "Workflow started",
  "session.workflow.fullscreen": "Fullscreen preview",
  "session.workflow.exitFullscreen": "Exit fullscreen",
  "session.workflow.sessionLog": "Session records",
  "session.workflow.sessionLog.description": "Triggered workflow sessions grouped by role, including staff seats that have not been triggered yet.",
  "session.workflow.sessionLog.empty": "No workflow sessions have been recorded yet.",
  "session.workflow.sessionLog.count": "{{count}} records",
  "session.workflow.sessionLog.requester": "Requester",
  "session.workflow.sessionLog.untriggered": "Not triggered",
  "session.workflow.sessionLog.attempt": "Attempt {{count}}",
  "session.workflow.sessionLog.source.workflow": "Workflow owner",
  "session.workflow.sessionLog.source.trigger": "Milestone trigger",
  "session.workflow.sessionLog.source.staff": "Staff seat",
  "session.workflow.openSession": "Open session",
  "session.workflow.openPlan": "Open plan file",
  "session.workflow.resume": "Resume workflow",
  "session.workflow.cancel": "Cancel workflow",
  "session.workflow.milestone": "Milestone",
  "session.workflow.xml": "Workflow XML",
  "session.workflow.saveXml": "Save XML",
  "session.workflow.xmlSaved.title": "Workflow XML saved",
  "session.workflow.request.title": "Start workflow",
  "session.workflow.request.label": "User requirement",
  "session.workflow.request.placeholder": "Describe what the workflow should deliver.",
  "session.workflow.variant.label": "Reasoning effort",
  "session.workflow.variant.description": "Applied to every workflow agent session.",
  "session.workflow.staffing.title": "Company staffing",
  "session.workflow.staffing.save": "Save staffing",
  "session.workflow.staffing.saved": "Workflow staffing saved",
  "session.workflow.staffing.mainPM": "Main PM",
  "session.workflow.staffing.departmentPM": "Department PM",
  "session.workflow.staffing.executor": "Executor",
  "session.workflow.staffing.reviewer": "Functional reviewer",
  "session.workflow.staffing.tester": "Tester",
  "session.workflow.staffing.expert": "Technical advisor",
  "session.workflow.modelWhitelist.title": "Role model whitelists",
  "session.workflow.modelWhitelist.description": "Allowed models, intelligence weight, and cache duration for this role.",
  "session.workflow.modelWhitelist.requester": "Requester",
  "session.workflow.modelWhitelist.add": "Add model",
  "session.workflow.modelWhitelist.empty": "No role-specific models. The workflow default model will be used.",
  "session.workflow.modelWhitelist.weight": "Weight",
  "session.workflow.modelWhitelist.cacheMinutes": "Cache min",
  "session.workflow.intervention.title": "Requester intervention",
  "session.workflow.intervention.placeholder": "Add direction, correction, or clarification for the workflow company.",
  "session.workflow.intervention.send": "Send intervention",
  "session.workflow.intervention.sent": "Workflow intervention recorded",
  "session.workflow.intervention.target": "Target role",
  "session.workflow.intervention.target.main_pm": "Main PM",
  "session.workflow.intervention.target.department_pm": "Department PM",
  "session.workflow.intervention.target.executor": "Executor",
  "session.workflow.intervention.target.reviewer": "Functional review",
  "session.workflow.intervention.target.tester": "Tester",
  "session.workflow.intervention.target.expert": "Technical advisor",
  "session.workflow.intervention.timing": "Timing",
  "session.workflow.intervention.timing.after-task": "After task",
  "session.workflow.intervention.timing.temporary-interrupt": "Temporary interrupt",
  "session.workflow.intervention.timing.interrupt": "Interrupt and pause",
  ...
  "settings.general.row.defaultPrompt.title": "Default prompt",
  "settings.general.row.defaultPrompt.description": "Add hidden instructions to every chat message",
  "settings.general.row.defaultPrompt.placeholder": "Always reply in Chinese",
  "settings.general.row.projectIgnore.title": "Project ignore list",
  "settings.general.row.projectIgnore.description": "Controls files shown to agents. Current source: {{source}}.",
  "settings.general.row.projectIgnore.placeholder": "node_modules\n.git\ndist\nbuild",
  "settings.general.row.projectIgnore.action.generate": "Generate project file",
  "settings.general.row.projectIgnore.source.project": "project .opencode/.ignore",
  "settings.general.row.projectIgnore.source.user": "user .opencode/.ignore",
  "settings.general.row.projectIgnore.source.default": "built-in defaults",
  "settings.general.row.projectIgnore.toast.saved.title": "Ignore list saved",
  "settings.general.row.projectIgnore.toast.saved.description": "Project .opencode/.ignore was updated.",
  ...
  "settings.permissions.section.mode": "Mode",
  "settings.permissions.section.rules": "Rules",
  "settings.permissions.section.tools": "Tools",
  "settings.permissions.toast.updateFailed.title": "Failed to update permissions",
  "settings.permissions.toast.updated.title": "Permissions updated",
  "settings.permissions.toast.updated.description": "New sessions will use the updated permission rules.",

  "settings.permissions.mode.ask.title": "Require approval",
  "settings.permissions.mode.ask.description":
    "Ask before running tool calls unless this session already has approval.",
  "settings.permissions.mode.whitelist.title": "Whitelist",
  "settings.permissions.mode.whitelist.description": "Deny by default; allow only matching tools and patterns.",
  "settings.permissions.mode.blacklist.title": "Blacklist",
  "settings.permissions.mode.blacklist.description": "Allow by default; deny matching tools and patterns.",
  "settings.permissions.mode.allow.title": "Allow all",
  "settings.permissions.mode.allow.description": "Allow all tool calls without asking.",

  "settings.permissions.rule.add": "Add rule",
  "settings.permissions.rule.remove": "Remove rule",
  "settings.permissions.rule.pattern": "Pattern",
  "settings.permissions.rule.allTools": "All tools",
  "settings.permissions.rule.empty.whitelist": "No whitelist rules. Everything will be denied.",
  "settings.permissions.rule.empty.blacklist": "No blacklist rules. Everything will be allowed.",
  ...
  "settings.permissions.tool.question.title": "Question",
  "settings.permissions.tool.question.description": "Ask the user a structured question",
  ...
  "settings.permissions.tool.repo_clone.title": "Repo Clone",
  "settings.permissions.tool.repo_clone.description": "Clone a repository",
  "settings.permissions.tool.repo_overview.title": "Repo Overview",
  "settings.permissions.tool.repo_overview.description": "Inspect a repository overview",
