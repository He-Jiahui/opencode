...
export const dict = {
  ...
  "session.plan.choose": "计划文件",
  "session.plan.change": "更换计划文件",
  "session.plan.enable": "计划继续",
  "session.plan.disable": "暂停计划模式",
  "session.plan.clear": "清除计划文件",
  "session.plan.openFromFile": "从文件打开",
  "session.plan.marker": "完成标记：{{marker}}",
  "session.plan.milestoneTag": "里程碑标签：{{open}}...{{close}}",
  "session.plan.milestones": "里程碑",
  "session.plan.milestone": "里程碑 {{count}}",
  "session.plan.complete.title": "计划已完成",
  "session.plan.complete.description": "智能体已返回完成标记。",
  "session.plan.block.label": "计划",
  "session.plan.block.save": "保存计划到工作区",
  "session.plan.block.copy": "复制计划",
  "session.plan.block.continue": "直接使用计划继续",
  "session.plan.block.saved.title": "计划已保存",
  "session.plan.block.ready.title": "计划已就绪",
  "session.plan.block.ready.description": "会话空闲后可在计划槽位点击继续。",
  "session.workflow.start": "启动 Workflow",
  "session.workflow.startAnother": "新建 Workflow",
  "session.workflow.belongsTo": "所属 Workflow",
  "session.workflow.started.title": "Workflow 已启动",
  "session.workflow.fullscreen": "全屏预览",
  "session.workflow.exitFullscreen": "退出全屏",
  "session.workflow.sessionLog": "会话记录",
  "session.workflow.sessionLog.description": "按职能汇总 workflow 已触发的会话，也显示尚未被触发的人员席位。",
  "session.workflow.sessionLog.empty": "还没有记录到 workflow 会话。",
  "session.workflow.sessionLog.count": "{{count}} 条记录",
  "session.workflow.sessionLog.requester": "请求者",
  "session.workflow.sessionLog.untriggered": "未触发",
  "session.workflow.sessionLog.attempt": "第 {{count}} 轮",
  "session.workflow.sessionLog.source.workflow": "Workflow 所有者",
  "session.workflow.sessionLog.source.trigger": "里程碑触发",
  "session.workflow.sessionLog.source.staff": "人员席位",
  "session.workflow.openSession": "打开对应 Session",
  "session.workflow.openPlan": "打开 Plan 文件",
  "session.workflow.resume": "继续 Workflow",
  "session.workflow.cancel": "取消 Workflow",
  "session.workflow.milestone": "里程碑",
  "session.workflow.xml": "Workflow XML",
  "session.workflow.saveXml": "保存 XML",
  "session.workflow.xmlSaved.title": "Workflow XML 已保存",
  "session.workflow.request.title": "启动 Workflow",
  "session.workflow.request.label": "用户需求",
  "session.workflow.request.placeholder": "描述这个 Workflow 需要交付的内容。",
  "session.workflow.variant.label": "思维深度",
  "session.workflow.variant.description": "应用到这个 Workflow 的所有 agent session。",
  "session.workflow.staffing.title": "公司人员配置",
  "session.workflow.staffing.save": "保存人员配置",
  "session.workflow.staffing.saved": "Workflow 人员配置已保存",
  "session.workflow.staffing.mainPM": "主 PM",
  "session.workflow.staffing.departmentPM": "部门 PM",
  "session.workflow.staffing.executor": "执行者",
  "session.workflow.staffing.reviewer": "功能 Review",
  "session.workflow.staffing.tester": "测试",
  "session.workflow.staffing.expert": "技术顾问",
  "session.workflow.modelWhitelist.title": "身份模型白名单",
  "session.workflow.modelWhitelist.description": "配置该身份可用的模型、智能权重和缓存时长。",
  "session.workflow.modelWhitelist.requester": "请求者",
  "session.workflow.modelWhitelist.add": "添加模型",
  "session.workflow.modelWhitelist.empty": "未配置专用模型，将使用 Workflow 默认模型。",
  "session.workflow.modelWhitelist.weight": "权重",
  "session.workflow.modelWhitelist.cacheMinutes": "缓存分钟",
  "session.workflow.intervention.title": "请求者干预",
  "session.workflow.intervention.placeholder": "输入对 workflow 公司的方向调整、纠正或补充说明。",
  "session.workflow.intervention.send": "发送干预",
  "session.workflow.intervention.sent": "Workflow 干预已记录",
  "session.workflow.intervention.target": "目标角色",
  "session.workflow.intervention.target.main_pm": "主 PM",
  "session.workflow.intervention.target.department_pm": "部门 PM",
  "session.workflow.intervention.target.executor": "执行者",
  "session.workflow.intervention.target.reviewer": "功能 Review",
  "session.workflow.intervention.target.tester": "测试",
  "session.workflow.intervention.target.expert": "技术顾问",
  "session.workflow.intervention.timing": "时机",
  "session.workflow.intervention.timing.after-task": "任务后处理",
  "session.workflow.intervention.timing.temporary-interrupt": "临时打断",
  "session.workflow.intervention.timing.interrupt": "打断并暂停",
  ...
  "settings.general.row.defaultPrompt.title": "默认提示词",
  "settings.general.row.defaultPrompt.description": "为每条普通对话消息附加隐藏指令",
  "settings.general.row.defaultPrompt.placeholder": "总是使用中文回复",
  "settings.general.row.projectIgnore.title": "项目忽略列表",
  "settings.general.row.projectIgnore.description": "控制展示给智能体的文件。当前来源：{{source}}。",
  "settings.general.row.projectIgnore.placeholder": "node_modules\n.git\ndist\nbuild",
  "settings.general.row.projectIgnore.action.generate": "生成项目文件",
  "settings.general.row.projectIgnore.source.project": "项目 .opencode/.ignore",
  "settings.general.row.projectIgnore.source.user": "用户 .opencode/.ignore",
  "settings.general.row.projectIgnore.source.default": "内置默认列表",
  "settings.general.row.projectIgnore.toast.saved.title": "忽略列表已保存",
  "settings.general.row.projectIgnore.toast.saved.description": "已更新项目 .opencode/.ignore。",
  ...
  "settings.permissions.section.mode": "模式",
  "settings.permissions.section.rules": "规则",
  "settings.permissions.section.tools": "工具",
  "settings.permissions.toast.updateFailed.title": "更新权限失败",
  "settings.permissions.toast.updated.title": "权限已更新",
  "settings.permissions.toast.updated.description": "新的会话将使用更新后的权限规则。",
  "settings.permissions.mode.ask.title": "需要用户同意",
  "settings.permissions.mode.ask.description": "运行工具调用前先询问，除非当前会话已经同意。",
  "settings.permissions.mode.whitelist.title": "白名单",
  "settings.permissions.mode.whitelist.description": "默认拒绝，仅允许匹配的工具和模式。",
  "settings.permissions.mode.blacklist.title": "黑名单",
  "settings.permissions.mode.blacklist.description": "默认允许，拒绝匹配的工具和模式。",
  "settings.permissions.mode.allow.title": "全部允许",
  "settings.permissions.mode.allow.description": "所有工具调用都直接允许，不再询问。",
  "settings.permissions.rule.add": "添加规则",
  "settings.permissions.rule.remove": "移除规则",
  "settings.permissions.rule.pattern": "匹配模式",
  "settings.permissions.rule.allTools": "所有工具",
  "settings.permissions.rule.empty.whitelist": "还没有白名单规则。所有工具都会被拒绝。",
  "settings.permissions.rule.empty.blacklist": "还没有黑名单规则。所有工具都会被允许。",
  ...
  "settings.permissions.tool.question.title": "问题",
  "settings.permissions.tool.question.description": "向用户发起结构化问题",
  ...
  "settings.permissions.tool.repo_clone.title": "仓库克隆",
  "settings.permissions.tool.repo_clone.description": "克隆代码仓库",
  "settings.permissions.tool.repo_overview.title": "仓库概览",
  "settings.permissions.tool.repo_overview.description": "查看仓库概览",
