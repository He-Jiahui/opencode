...
export const dict = {
  ...
  "session.plan.choose": "計畫檔案",
  "session.plan.change": "更換計畫檔案",
  "session.plan.enable": "計畫繼續",
  "session.plan.disable": "暫停計畫模式",
  "session.plan.clear": "清除計畫檔案",
  "session.plan.openFromFile": "從檔案開啟",
  "session.plan.marker": "完成標記：{{marker}}",
  "session.plan.milestoneTag": "里程碑標籤：{{open}}...{{close}}",
  "session.plan.milestones": "里程碑",
  "session.plan.milestone": "里程碑 {{count}}",
  "session.plan.complete.title": "計畫已完成",
  "session.plan.complete.description": "代理已回傳完成標記。",
  "session.plan.block.label": "計畫",
  "session.plan.block.save": "儲存計畫到工作區",
  "session.plan.block.copy": "複製計畫",
  "session.plan.block.continue": "直接使用計畫繼續",
  "session.plan.block.saved.title": "計畫已儲存",
  "session.plan.block.ready.title": "計畫已就緒",
  "session.plan.block.ready.description": "會話閒置後可在計畫槽位點擊繼續。",
  "session.workflow.start": "啟動 Workflow",
  "session.workflow.startAnother": "新建 Workflow",
  "session.workflow.belongsTo": "所屬 Workflow",
  "session.workflow.started.title": "Workflow 已啟動",
  "session.workflow.fullscreen": "全螢幕預覽",
  "session.workflow.exitFullscreen": "退出全螢幕",
  "session.workflow.sessionLog": "會話記錄",
  "session.workflow.sessionLog.description": "按職能彙總 workflow 已觸發的會話，也顯示尚未被觸發的人員席位。",
  "session.workflow.sessionLog.empty": "還沒有記錄到 workflow 會話。",
  "session.workflow.sessionLog.count": "{{count}} 筆記錄",
  "session.workflow.sessionLog.requester": "請求者",
  "session.workflow.sessionLog.untriggered": "未觸發",
  "session.workflow.sessionLog.attempt": "第 {{count}} 輪",
  "session.workflow.sessionLog.source.workflow": "Workflow 擁有者",
  "session.workflow.sessionLog.source.trigger": "里程碑觸發",
  "session.workflow.sessionLog.source.staff": "人員席位",
  "session.workflow.openSession": "開啟對應 Session",
  "session.workflow.openPlan": "開啟 Plan 檔案",
  "session.workflow.resume": "繼續 Workflow",
  "session.workflow.cancel": "取消 Workflow",
  "session.workflow.milestone": "里程碑",
  "session.workflow.xml": "Workflow XML",
  "session.workflow.saveXml": "儲存 XML",
  "session.workflow.xmlSaved.title": "Workflow XML 已儲存",
  "session.workflow.request.title": "啟動 Workflow",
  "session.workflow.request.label": "使用者需求",
  "session.workflow.request.placeholder": "描述這個 Workflow 需要交付的內容。",
  "session.workflow.variant.label": "思維深度",
  "session.workflow.variant.description": "套用到這個 Workflow 的所有 agent session。",
  "session.workflow.staffing.title": "公司人員配置",
  "session.workflow.staffing.save": "儲存人員配置",
  "session.workflow.staffing.saved": "Workflow 人員配置已儲存",
  "session.workflow.staffing.mainPM": "主 PM",
  "session.workflow.staffing.departmentPM": "部門 PM",
  "session.workflow.staffing.executor": "執行者",
  "session.workflow.staffing.reviewer": "功能 Review",
  "session.workflow.staffing.tester": "測試",
  "session.workflow.staffing.expert": "技術顧問",
  "session.workflow.modelWhitelist.title": "身份模型白名單",
  "session.workflow.modelWhitelist.description": "配置該身份可用的模型、智能權重和快取時長。",
  "session.workflow.modelWhitelist.requester": "請求者",
  "session.workflow.modelWhitelist.add": "新增模型",
  "session.workflow.modelWhitelist.empty": "未配置專用模型，將使用 Workflow 預設模型。",
  "session.workflow.modelWhitelist.weight": "權重",
  "session.workflow.modelWhitelist.cacheMinutes": "快取分鐘",
  "session.workflow.intervention.title": "請求者干預",
  "session.workflow.intervention.placeholder": "輸入對 workflow 公司的方向調整、修正或補充說明。",
  "session.workflow.intervention.send": "送出干預",
  "session.workflow.intervention.sent": "Workflow 干預已記錄",
  "session.workflow.intervention.target": "目標角色",
  "session.workflow.intervention.target.main_pm": "主 PM",
  "session.workflow.intervention.target.department_pm": "部門 PM",
  "session.workflow.intervention.target.executor": "執行者",
  "session.workflow.intervention.target.reviewer": "功能 Review",
  "session.workflow.intervention.target.tester": "測試",
  "session.workflow.intervention.target.expert": "技術顧問",
  "session.workflow.intervention.timing": "時機",
  ...
  "settings.general.row.defaultPrompt.title": "預設提示詞",
  "settings.general.row.defaultPrompt.description": "為每則普通對話訊息附加隱藏指令",
  "settings.general.row.defaultPrompt.placeholder": "總是使用中文回覆",
  "settings.general.row.projectIgnore.title": "專案忽略清單",
  "settings.general.row.projectIgnore.description": "控制顯示給智慧體的檔案。目前來源：{{source}}。",
  "settings.general.row.projectIgnore.placeholder": "node_modules\n.git\ndist\nbuild",
  "settings.general.row.projectIgnore.action.generate": "產生專案檔案",
  "settings.general.row.projectIgnore.source.project": "專案 .opencode/.ignore",
  "settings.general.row.projectIgnore.source.user": "使用者 .opencode/.ignore",
  "settings.general.row.projectIgnore.source.default": "內建預設清單",
  "settings.general.row.projectIgnore.toast.saved.title": "忽略清單已儲存",
  "settings.general.row.projectIgnore.toast.saved.description": "已更新專案 .opencode/.ignore。",
  ...
  "settings.permissions.section.rules": "規則",
  "settings.permissions.section.tools": "工具",
  "settings.permissions.toast.updateFailed.title": "更新權限失敗",
  "settings.permissions.toast.updated.title": "權限已更新",
  "settings.permissions.toast.updated.description": "新的工作階段將使用更新後的權限規則。",

  "settings.permissions.action.allow": "允許",
  "settings.permissions.action.ask": "詢問",
  "settings.permissions.action.deny": "拒絕",

  "settings.permissions.mode.ask.title": "需要使用者同意",
  "settings.permissions.mode.ask.description": "執行工具呼叫前先詢問，除非目前工作階段已經同意。",
  "settings.permissions.mode.whitelist.title": "白名單",
  "settings.permissions.mode.whitelist.description": "預設拒絕，只允許符合的工具和模式。",
  "settings.permissions.mode.blacklist.title": "黑名單",
  "settings.permissions.mode.blacklist.description": "預設允許，拒絕符合的工具和模式。",
  "settings.permissions.mode.allow.title": "全部允許",
  "settings.permissions.mode.allow.description": "所有工具呼叫都直接允許，不再詢問。",

  "settings.permissions.rule.add": "新增規則",
  "settings.permissions.rule.remove": "移除規則",
  "settings.permissions.rule.pattern": "符合模式",
  "settings.permissions.rule.allTools": "所有工具",
  "settings.permissions.rule.empty.whitelist": "尚無白名單規則。所有工具都會被拒絕。",
  "settings.permissions.rule.empty.blacklist": "尚無黑名單規則。所有工具都會被允許。",
  ...
  "settings.permissions.tool.question.title": "問題",
  "settings.permissions.tool.question.description": "向使用者提出結構化問題",
  ...
  "settings.permissions.tool.repo_clone.title": "倉庫複製",
  "settings.permissions.tool.repo_clone.description": "複製程式碼倉庫",
  "settings.permissions.tool.repo_overview.title": "倉庫概覽",
  "settings.permissions.tool.repo_overview.description": "查看倉庫概覽",
