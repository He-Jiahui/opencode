...
it.instance("plan agent denies edits except project plan directories", () =>
  Effect.gen(function* () {
    ...
    expect(Permission.evaluate("edit", ".codex/plans/foo.md", plan!.permission).action).toBe("allow")
  }),
)
