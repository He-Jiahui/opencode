export const DEFAULT_MODEL_VARIANT = "default"
...
export function resolveModelVariant(input: VariantInput) {
  if (input.selected === DEFAULT_MODEL_VARIANT) return undefined
...
export function cycleModelVariant(input: VariantInput) {
  ...
  if (input.selected === DEFAULT_MODEL_VARIANT) return input.variants[0]
